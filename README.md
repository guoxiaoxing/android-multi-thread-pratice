...
![](android-multi-thread-pratice/image/android_perf_5_threadpriority_CPU.png)
...
![](android-multi-thread-pratice/image/android_perf_5_threadpriority_90.png)
...
![](android-multi-thread-pratice/image/android_perf_5_threadpriority_less.png)
...
![](android-multi-thread-pratice/image/android_perf_5_threadpriority_const.png)


大多数情况下，新创建的线程优先级会被设置为默认的0，主线程设置为0的时候，新创建的线程还可以利用THREAD_PRIORITY_LESS_FAVORABLE或者THREAD_PRIORITY_MORE_FAVORABLE来控制线程的优先级。

![](android-multi-thread-pratice/image/android_perf_5_threadpriority_value.png)

Android系统里面的AsyncTask与IntentService已经默认帮助我们设置线程的优先级，但是对于那些非官方提供的多线程工具类，我们需要特别留意根据需要自己手动来设置线程的优先级。

![](android-multi-thread-pratice/image/android_perf_5_threadpriority_asynctask.png)
![](android-multi-thread-pratice/image/android_perf_5_threadpriority_intentservice.png)
...
![](android-multi-thread-pratice/image/android_perf_5_loader_bad.png)

Loader的出现就是为了确保工作线程能够和Activity的生命周期保持一致，同时避免出现前面提到的问题。

![](android-multi-thread-pratice/image/android_perf_5_loader_good.png)
...
![](android-multi-thread-pratice/image/android_perf_5_threadpool_3.png)
...
![](android-multi-thread-pratice/image/android_perf_5_threadpool_4.png)
...
![](android-multi-thread-pratice/image/android_perf_5_intentservice_outline.png)
